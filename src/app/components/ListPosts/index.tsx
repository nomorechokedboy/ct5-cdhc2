        ...
        <main className="flex-1 p-6 min-h-0">
          <div className="space-y-6 w-full">
            {filteredPosts.map((post) => (
              <Card key={post.id} className="group hover:shadow-md transition-shadow w-full min-w-full h-fit">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between w-full">
                    <div className="w-full">
                      ...
                      <Link href={`/categories/post/${post.title}?id=${post.id}`}>
                ...
                <CardContent className="pt-0 w-full">
                  <p className="text-muted-foreground text-pretty leading-relaxed mb-4 line-clamp-3">{post.excerpt}</p>
