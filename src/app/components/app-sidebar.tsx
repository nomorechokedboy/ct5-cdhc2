				...
				<SidebarMenuItem>
					...
					>
						<CollapsibleTrigger asChild>
							<SidebarMenuButton className='flex items-center gap-3 rounded-xl px-4 py-2 font-medium text-gray-700 transition-colors hover:[background-color:oklch(0.65_0.22_285.8)] focus:[background-color:oklch(0.65_0.22_285.8)] cursor-pointer'>
			...
			return (
				<SidebarMenuItem>
					<SidebarMenuButton
						...
						className='flex items-center gap-3 rounded-xl px-4 py-2 font-medium text-gray-700 transition-colors hover:[background-color:oklch(0.65_0.22_285.8)] focus:[background-color:oklch(0.65_0.22_285.8)] cursor-pointer'
					>
						<Link
							href={item.url}
		...
		<SidebarMenuSubItem>
			{hasChildren ? (
				<Collapsible className='group/collapsible' defaultOpen>
					<CollapsibleTrigger asChild>
						<SidebarMenuSubButton className='flex items-center gap-3 rounded-xl px-4 py-2 font-medium text-gray-700 transition-colors hover:[background-color:oklch(0.65_0.22_285.8)] focus:[background-color:oklch(0.65_0.22_285.8)] cursor-pointer'>
							{Icon && <Icon className='w-5 h-5  ' />}
							{!isCollapsed && <span>{item.title}</span>}
							{!isCollapsed && (
								<ChevronDown className='ml-auto transition-transform group-data-[state=open]/collapsible:rotate-180' />
				...
				<SidebarMenuSubButton
					asChild
					isActive={item.isActive}
					className='flex items-center gap-3 rounded-xl px-4 py-2 font-medium text-gray-700 transition-colors  hover:[background-color:oklch(0.65_0.22_285.8)]  focus:[background-color:oklch(0.65_0.22_285.8)] '
				>
					<Link
						href={item.url}
						className='flex items-center gap-3 w-full'
